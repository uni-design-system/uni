...
}`,...i.parameters?.docs?.source},description:{story:"`as` keeps the semantics yours — this one renders a `<main>` element.",...i.parameters?.docs?.description}}};export{t as FlexContainer,o as Primary,i as SemanticElement,w as __namedExportsOrder,f as default};
