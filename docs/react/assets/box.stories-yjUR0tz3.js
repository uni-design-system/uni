...
}`,...i.parameters?.docs?.source},description:{story:"`as` keeps the semantics yours — this one renders a `<main>` element.",...i.parameters?.docs?.description}}};const y=["Primary","FlexContainer","SemanticElement"];export{t as FlexContainer,o as Primary,i as SemanticElement,y as __namedExportsOrder,S as default};
