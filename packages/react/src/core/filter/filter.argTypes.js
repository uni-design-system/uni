...
export const filterArgTypes = {
    blur: {
        ...
        description: 'Applies a blur effect to the image. A larger value will create more blur.\n' +
            '\n' +
    ...
    'hue-rotate': {
        ...
        description: 'Applies a hue rotation on the image. The value defines the number of degrees around the color circle the image samples will be adjusted. 0deg is default, and represents the original image.',
    },
    invert: {
        control: { type: 'range', min: 0, max: 100, step: 1 },
        table: {
        ...
        description: 'Inverts the samples in the image.\n' +
            '\n' +
            '0% (0) is default and represents the original image.\n' +
    ...
    opacity: {
        ...
        description: 'Sets the opacity level for the image. The opacity-level describes the transparency-level, where:\n' +
            '\n' +
